...
import com.order.bachlinh.core.component.search.index.internal.IndexPositionContainer;
...
public abstract class AbstractIndexLocator implements IndexLocator {
    private static final String ERROR_MSG = "Can not open channel because IOException";
